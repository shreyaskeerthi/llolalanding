export default function Features() {
  const features = [
    ...
    {
      title: "Unauthorized discounts & exceptions",
      description:
    ...
    {
      title: "Hallucinations under pressure",
      description:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Comprehensive testing across the failure modes that matter most for
            customer-facing AI.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="group p-6 bg-dark-card rounded-xl border border-dark-border hover:border-accent/50 hover:shadow-2xl transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-lg bg-accent/20 text-accent flex items-center justify-center mb-4 group-hover:bg-accent group-hover:text-white transition-all border border-accent/30">
                {feature.icon}
              </div>
